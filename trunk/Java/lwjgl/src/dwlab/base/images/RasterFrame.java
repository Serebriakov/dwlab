		...
		if( proportional ) {
			...
			if( topBorder != 0 || bottomBorder != 0 ) {
				...
				for( int n = 0; n <= 2 ; n++ ) {
					...
					draw( frame, currentX, currentY, width, currentHeight, 0, currentTY, frameWidth, currentTY + currentTHeight, 0d, color );
				...
				for( int m = 0; m <= 2; m++ ) {
					...
					draw( frame, currentX, currentY, currentWidth, 0, currentTX, 0, currentTX + currentTWidth, frameHeight, 0d, color );
			...
			for( int n = 0; n <= 2 ; n++ ) {
				...
				for( int m = 0; m <= 2; m++ ) {
					...
					draw( frame, currentX, currentY, currentWidth, currentHeight, currentTX, currentTY, currentTX + currentTWidth, currentTY + currentTHeight, 0d, color );
